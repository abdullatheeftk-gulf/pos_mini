...
import 'package:pos_mini/screens/main/screens/add/widgets/add_product_screen/widget/check_box_for_categories_display.dart';
...
class BigScreenProductAddScreen extends StatefulWidget {
  final Function callBack;
  final Category? incomingCategory;

  const BigScreenProductAddScreen(
      {super.key, required this.callBack, required this.incomingCategory});

  @override
  State<BigScreenProductAddScreen> createState() =>
      _BigScreenProductAddScreenState();
}

class _BigScreenProductAddScreenState extends State<BigScreenProductAddScreen> {
