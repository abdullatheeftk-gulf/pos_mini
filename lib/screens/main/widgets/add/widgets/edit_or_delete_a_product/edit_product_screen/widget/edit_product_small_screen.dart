...
class EditProductSmallScreen extends StatefulWidget {
  ...
  const EditProductSmallScreen(
      {super.key, required this.product, required this.callBack});

  @override
  State<EditProductSmallScreen> createState() => _EditProductSmallScreenState();
}

class _EditProductSmallScreenState extends State<EditProductSmallScreen> {
                      ...
                      children: [
                        Radio(
                          ...
                          onChanged: (value) {
                            context
                                .read<EditProductCubit>()
                                .translate(_productNameController.text.trim());
                            setState(() {
                              _selectedRadio = 1;
                            });
                          },
                    ...
                    Row(
                      children: [
                        Radio(
                          ...
                          onChanged: (value) {
                            context.read<EditProductCubit>().transliterate(
