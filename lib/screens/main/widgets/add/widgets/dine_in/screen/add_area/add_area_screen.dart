...
import 'package:pos_mini/screens/main/widgets/add/widgets/dine_in/screen/add_area/child/add_area_dialog.dart';
import 'package:pos_mini/screens/main/widgets/add/widgets/dine_in/screen/add_area/child/edit_area_dialog.dart';
...
class _AddAreaScreenState extends State<AddAreaScreen> {
  ...
  void _showEditDialog(DineInArea dineInArea) {
    showDialog(context: context, builder: (ctx){
      return  EditAreaDialog(dineInArea: dineInArea,);
    });
  }
                                              ...
                                              child: PopupMenuButton<
                                                ...
                                                onSelected: (cb) {
                                                  if (cb.name ==
                                                      PopUpMenuButton
                                                          .edit.name) {
                                                    _areaCubit.showEditAlertDialog(_listOfDineInArea[index]);
                                                  }
                                                  if (cb.name ==
                                                      PopUpMenuButton
                                                          .delete.name) {
                                                    _areaCubit.deleteAnAreaById(_listOfDineInArea[index]);
                                                  }
                                                },
                                                itemBuilder:
